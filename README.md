...
| [mason-lspconfig.nvim](https://github.com/mason-org/mason-lspconfig.nvim)      | Bridge between mason.nvim and nvim-lspconfig for automatic LSP server installation.                                                                |
...
| [friendly-snippets](https://github.com/rafamadriz/friendly-snippets)           | Collection of pre-configured snippets for various languages.                                                                                       |
| [LuaSnip](https://github.com/L3MON4D3/LuaSnip)                                 | Snippet Engine for Neovim written in Lua                                                                                                           |
| [nvim-autopairs](https://github.com/windwp/nvim-autopairs)                     | A super powerful autopairs for Neovim                                                                                                              |
| [conform.nvim](https://github.com/stevearc/conform.nvim)                       | Lightweight formatter runner for Neovim.                                                                                                           |
| [lualine.nvim](https://github.com/nvim-lualine/lualine.nvim)                   | A blazing fast and easy to configure neovim statusline plugin written in pure lua.                                                                 |
| [nvim-highlight-colors](https://github.com/brenoprata10/nvim-highlight-colors) | Highlight colors for Neovim (hex, rgb, hsl).                                                                                                       |
...
| [nvim-mini/mini.misc](https://github.com/nvim-mini/mini.misc)                  | Miscellaneous useful functions. Part of 'mini.nvim' library.                                                                                       |
...
| [none-ls-extras.nvim](https://github.com/nvimtools/none-ls-extras.nvim)        | Extra sources for none-ls.nvim.                                                                                                                    |
